...
namespace com.google.zxing.oned
{
	...
	public sealed class MultiFormatOneDReader:OneDReader
	{
        ...
        System.Collections.Generic.List<Object> readers;

        public MultiFormatOneDReader(System.Collections.Generic.Dictionary<Object,Object> hints)
		{
            System.Collections.Generic.List<Object> possibleFormats = null; 
            
            if (hints != null && hints.ContainsKey(DecodeHintType.POSSIBLE_FORMATS))
            {
                possibleFormats = hints[DecodeHintType.POSSIBLE_FORMATS] as List<Object>;
            }
			bool useCode39CheckDigit = hints != null && hints.ContainsKey(DecodeHintType.ASSUME_CODE_39_CHECK_DIGIT) && hints[DecodeHintType.ASSUME_CODE_39_CHECK_DIGIT] != null;
