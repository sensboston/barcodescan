...
public class RGBLuminanceSource : LuminanceSource
{
    ...
    private Microsoft.Xna.Framework.Rectangle __Region;  
    ...
    public RGBLuminanceSource(byte[] d, int W, int H, bool Is8Bit, Microsoft.Xna.Framework.Rectangle Region)
        : base(W, H)
    {
        ...
        //if (format == PixelFormat.Format8bppIndexed)
        {
            ...
            for (int y = 0; y < height; y++)
            {
                ...
                for (int x = 0; x < width; x++)
                {
                    ...
                    luminances[offset + x] = (sbyte)((int)((srcPixel >> 16) & 0xff) << 16 | ((int)((srcPixel >> 8) & 0xff)) << 8 | ((int)(srcPixel & 0xff)));
                }
            }
        }
    }
